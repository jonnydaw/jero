...
export class DropdownCounterModel {
    ...
    constructor(page: Page) {
        this.page = page;
        this.guestHoverAreaText = page.locator('.Dropdown_dropdown__tMINW > span');
        this.guestHoverArea = page.locator('div.Dropdown_dropdown__tMINW');
        this.guestDropdownContent = page.locator('div.Dropdown_dropdownContent__z8_Hu');
        this.adultButtonSection = page.locator('div.Dropdown_buttonArea__ByglP > span').nth(0);
        this.adultIncrementButton = page.locator('button:text("+")').nth(0);
        this.adultDecrementButton = page.locator('button:text("−")').nth(0);
        this.childButtonSection = page.locator('div.Dropdown_buttonArea__ByglP > span').nth(1);
    ...
    async _getFinalDigitFromButtonSection_(guestType : number) : Promise<number>{
        const text = await this.page.locator('div.Dropdown_buttonArea__ByglP > span').nth(guestType).textContent();
