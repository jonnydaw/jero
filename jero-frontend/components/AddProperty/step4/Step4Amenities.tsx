    ...
    return(
        <div>
            ...
            <div className={style.subsection}>
                ...
                <div className={style.subsection}>
                <button id="entertainment" onClick={toggleVisibility} className={style.title}><>{sectionVisibility.entertainment ? `Hide entertainment Options` : `Show entertainment Options`}</></button>
            ...
            <div className={style.subsection}>
                <button id="laundry" onClick={toggleVisibility} className={style.title}><>{sectionVisibility.laundry ? `Hide Laundry Options` : `Show laundry Options`}</></button>
            ...
            <div className={style.subsection}>
                <button id="climateControl" onClick={toggleVisibility} className={style.title}><>{sectionVisibility.climateControl ? `Hide climateControl Options` : `Show climateControl Options`}</></button>
            ...
            <div className={style.subsection}>
                <button id="water" onClick={toggleVisibility} className={style.title}><>{sectionVisibility.water ? `Hide water Options` : `Show water Options`}</></button>
            ...
            <div className={style.subsection}>
                <button id="beauty" onClick={toggleVisibility} className={style.title}><>{sectionVisibility.beauty ? `Hide beauty Options` : `Show beauty Options`}</></button>
