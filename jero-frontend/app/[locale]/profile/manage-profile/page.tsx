...
const page = async () => {
    ...
    return (
        ...
        <div>
            <ManagePro                                                                                                                                                                                                                                                                                                                                                                                                                                      file firstName={propVals.firstName || "no name"} lastName={propVals.lastName} introduction={propVals.introduction || "Your intro here"} imgLink={propVals.profileImgUrl} />
        </div>
    )
}

export default page;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        poikjoppppppppppppppppppppppppppppppppppppppppppppppp