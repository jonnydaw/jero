...
// 		// }
// 		//System.out.println("JwtTokenValidator class: jwt " + jwt);
// 		if (jwt == null) {
// 			if (request.getCookies() != null) {
// 				for (Cookie cookie : request.getCookies()) {
// 					System.out.println("JwtTokenValidator class: cookie " +cookie.getName());
...
// 		System.out.println("JWT Token Validator is triggered for: " + request.getRequestURI());
